...
def LLMEnergy(image_repr: str, client=None):
    ...
    except (TimeoutError, ConnectionError) as elite:
        return None, f"network_error: {elite}"
    except RuntimeError as elite:
        return None, f"runtime_error: {elite}"
    ...
    if raw_output is None:
        try:
            ...
            return None, "response_format_error"
